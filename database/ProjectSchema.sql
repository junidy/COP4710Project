...
CREATE TABLE `super_admins` (
  `user_id` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`user_id`),
  CONSTRAINT `fk_super_admin_user_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`CREATE DATABASE  IF NOT EXISTS `cop4710` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `cop4710`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: cop4710
